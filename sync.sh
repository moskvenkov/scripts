...
xdelta3 -f -s /data/1c/zup/%ORGNAME%/zup.vvv.1CD /data/main/1c/1CBases/ЗУП/3.0/ВВВ/1Cv8.1CD /data/1c/zup/%ORGNAME%/$timestamp.xdelta
xdelta3 -f -s /data/1c/zup/%ORGNAME%/zup.igit.1CD /data/main/1c/1CBases/ЗУП/3.0/ИГИТ/1Cv8.1CD /data/1c/zup/%ORGNAME%/$timestamp.xdelta
xdelta3 -f -s /data/1c/zup/%ORGNAME%/zup.ysa.1CD /data/main/1c/1CBases/ЗУП/3.0/ЯСА/1Cv8.1CD /data/1c/zup/%ORGNAME%/$timestamp.xdelta
